...
<!-- alert alert-warning alert-block -->
	<div class="alert alert-warning alert-block" style="height: 700px;background-image:url('${pageContext.servletContext.contextPath }/admin_files/1.jpg');">
		<table style="margin-left: 270px;height: 500px;margin-bottom: 100px;" >
			<tr>
				<td align="center" colspan="2"><h1>干部测评系统</h1></td>
			</tr>
			<tr>
