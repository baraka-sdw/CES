...
<script type="text/javascript" src="${ctx}/js/system/targetnext/add.js">
</script>
<style type="text/css">
.col-sm-3 {
	width: 15%;
...
<body>
	...
	<form id="form" name="form" class="form-horizontal" method="post"
		action="${ctx}/targetnext/addEntity.shtml">
...
<!-- 			</div> -->
            ...
            <div class="form-group">
				...
				<div class="col-sm-4">
				    ...
				    name="targetNextFormMap.description" id="description"></textarea>
				</div>
			</div>   
