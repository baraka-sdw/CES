...
<script type="text/javascript" src="${ctx}/js/system/targetone/edit.js">
</script>
<style type="text/css">
.col-sm-3 {
	width: 15%;
...
<body>
	...
	<form id="form" name="form" class="form-horizontal" method="post"
		...
		<input type="hidden" class="form-control checkacc" value="${targetone.id}"
			name="targetOneFormMap.id" id="id">
