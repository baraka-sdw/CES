...
<script type="text/javascript" src="${ctx}/js/system/evaluate/edit.js"></script>
...
<body>
	...
	<form id="form" name="form" class="form-horizontal" method="post"
		action="${ctx}/evaluate/editEntity.shtml">
			<input type="hidden" class="form-control checkacc" value="${evaluate.id}"
			name="evaluateFormMap.id" id="id">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control checkacc"
						...
						id="evaluateName" value="${evaluate.evaluateName}">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control checkacc"
						...
						id="evaluateCode" value="${evaluate.evaluateCode}">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control checkacc"
						placeholder="请输入参评人数" name="evaluateFormMap.score" id="number"
